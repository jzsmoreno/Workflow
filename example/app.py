...
from figure import plotly_figure_1, plotly_figure_2
...
models = {"Árbol de decisión": iris_classifier()}
...
sepal_lenght = st.slider("Longitud del sépalo", 0.0, 10.0, 5.0, 0.05)
sepal_width = st.slider("Ancho del sépalo", 0.0, 5.0, 2.5, 0.05)
petal_lenght = st.slider("Longitud del pétalo", 0.0, 8.0, 4.0, 0.05)
petal_width = st.slider("Ancho del pétalo", 0.0, 3.0, 1.5, 0.05)
